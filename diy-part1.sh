...
git submodule add https://github.com/pymumu/smartdns.git package/external-packages/smartdns
git submodule add https://github.com/pymumu/luci-app-smartdns.git package/external-packages/luci-app-smartdns
